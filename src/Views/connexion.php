...
<body onload="DisplayAccueil();  GetWindowHeight();" id="collections" onresize="GetWindowHeight()">
    ...
    <div id="creationProfil">
        <h1 class="size5 bold spacebottom1" style="text-align: center;margin-top: 10%;">Connexion</h1>
        ...
        <form  method="post" style="margin: auto;" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn bg-purple size2 white" name="connexion">Se connecter</button>
        </form>
    </div>
