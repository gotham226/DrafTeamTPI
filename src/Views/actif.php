...
<body onload="DisplayAccueil();  GetWindowHeight();" id="collections" onresize="GetWindowHeight()">
    ...
    <div>
        ...
        <h1 class="size5 bold spacebottom1" style="text-align: center; margin-top:7%;">Veux-tu vraiment activer ce championnat ?</h1>
        <h1 style=" margin-top:1%;" class="spacebottom3 halfwhite size2 ta-center">En activant ce championnat, cela désactivera le championnat en cours pour votre équipe</h1>
