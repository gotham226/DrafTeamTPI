 ...
 * Date: 08.05.2023
 * Description: Page pour la vue de la suppresion d'un sportif 
 * Version 1.0
 */ -->
<!DOCTYPE html>
<html lang="fr">
...
<body onload="DisplayAccueil();  GetWindowHeight();" id="collections" onresize="GetWindowHeight()">
    ...
    <div>
        ...
        <h1 class="size5 bold spacebottom1" style="text-align: center; margin-top:7%;">Veux-tu vraiment supprimer ce sportif ?</h1>
